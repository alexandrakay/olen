...
export const SOFT_LIMIT_WARNING =
  "You have 7 active contexts. Olen works best when you're tracking what actually competes for your attention — consider archiving one before adding another.";
